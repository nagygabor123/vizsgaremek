                      ...
                      paginatedStudents.map((student) => {
                        ...
                        return (
                          <tr key={student.student_id} className="text-center text-sm border-t">
                            ...
                            <td className="p-1">
                              {student.status === "ki" ? <span className="text-slate-400"><CircleMinus className="w-4 h-4 inline-block" /></span> : student.status === "be" ? <span className="text-green-500"><CircleCheck className="w-4 h-4 inline-block" /></span> : <span className="text-red-500"><CircleAlert className="w-4 h-4 inline-block" /></span>}
